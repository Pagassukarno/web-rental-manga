...
<div class="carousel-item active" style="height: 500px; width: 1200px;">
                            <img class="img-fluid" src="<?php echo base_url ('img/dc.jpg') ?>" alt="Image">
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center ">
                                <div class="p-3" style="max-width: 500px;">
                                <h3 class="display-4 text-white font-weight-semi-bold mb-4">Detektife Conan</h3>            
                                </div>
                            </div>
                        </div>
</div>
    ...
    <div class="col-lg-10" style="margin-left: 110px;">
                <div class="row">    
 <?php if (!empty($product_listdc)): ?>
    
    <?php 
        $a = 1;
        foreach($product_listdc as $product): ?> 
                    ...
                    <div class="col col-lg-4 col-md-3 col-sm-12 pb-1">
                        <div class="card product-item border-0 mb-4">
                            <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                                ...
                                else echo base_url ('img/detektifconan-vol5.jpeg');
                                ++$a;
                                ?>" alt="">
                            </div>
